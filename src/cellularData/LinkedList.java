...
public class LinkedList<T> implements Iterable<T> {
	...
	/**
	 * Returns the country object from the linked list. It iterates through
	 * the linked list to find a matching name. If found, it will return the country
	 * object. Else, it returns null. Only works for Country objects.
	 * 
	...
	public Country getCountry (String country ) {
		...
		Country temp;
		while (walker != null) {
			temp = (Country) walker.getData();
			if (temp.getName().equalsIgnoreCase(country)) {
